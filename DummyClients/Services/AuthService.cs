...

{
    ...
    internal class AuthService
    {
        ...
        internal async Task LoginAsync(ClientSession session, string id, string pwd)
        {
        ...
        public async Task<(string serverAddress, int serverPort)> GetSessionAsync(ClientSession session)
        {
