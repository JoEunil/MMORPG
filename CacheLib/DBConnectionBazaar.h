...
namespace Cache
{
    ...
    class DBConnectionBazaar : public DBConnection {
        void Connect() {
            sql::SQLString host = DB_HOST_BAZAAR;
            sql::SQLString user = DB_USER_BAZAAR;
            sql::SQLString password = DB_PASS_BAZAAR;
            sql::SQLString database = DB_DB_BAZAAR;
